...
```mermaid
graph TB
    A["🎯 VB6 Portable IDE<br/>Original Distribution"] --> B["🔬 Research Platform"]
    B --> C["🚀 VB9 Project<br/>Visual Basic for Plan 9"]
    B --> D["📚 Technical Documentation<br/>76+ Diagrams"]
    B --> E["🧠 Computing Insights<br/>Fonts, Drawing, Architecture"]
    
    C --> F["📁 File-based Controls<br/>Every UI element = file"]
    C --> G["🌐 Distributed Computing<br/>Forms across network"]  
    C --> H["🔢 Prime Number Architecture<br/>Controls as computational primes"]
    
    E --> I["📝 Font Systems = Code"]
    E --> J["🎨 Drawing = Computing"]
    E --> K["🔄 UI = Distributed System"]
```
...
```plantuml
@startuml
package "VB6 Portable (6MB)" {
    [Form Designer] as vb6form
    [Controls Library] as vb6controls  
    [Runtime Engine] as vb6runtime
    [Event System] as vb6events
}

package "VB9 Distributed (<1MB)" {
    [File-based Forms] as vb9form
    [Prime Controls] as vb9controls
    [9P Runtime] as vb9runtime
    [File Events] as vb9events
}

package "Plan 9 Infrastructure" {
    [9P Protocol] as ninep
    [Namespace] as namespace
    [Draw Device] as draw
    [Network Layer] as network
}

vb6form --> vb9form : "Visual design preserved"
vb6controls --> vb9controls : "Becomes prime-factorized"
vb6runtime --> vb9runtime : "1.4MB → <1MB"
vb6events --> vb9events : "Click → File write"

vb9form --> ninep
vb9controls --> namespace
vb9runtime --> draw
vb9events --> network
@enduml
```
